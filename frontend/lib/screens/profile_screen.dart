...
class _ProfileScreenState extends State<ProfileScreen> {
            ...
            return AlertDialog(
              ...
              actions: [
                ElevatedButton(
                  ...
                  child: const Text('LISTO', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
                ),
              ],
            );
          },
  ...
  Future<void> _cargarDatosDeBaseDeDatos() async {
    ...
    if (data != null && data['horario'] != null) {
      setState(() {
        _nameController.text = data['nombre'] ?? '';
        
        // Mapeamos lo que responde el servidor a nuestra lista local
  ...
  void _handleSend() async {
    ...
    // Pasamos de List<List<String>> a la List<String> plana que espera Node.js, uniendo con comas
    List<String> horarioParaEnviar = _scheduleData.map((listaTiempos) {
      return listaTiempos.isEmpty ? 'Sin asignar' : listaTiempos.join(', ');
    }).toList();
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 28),
                              const Text('HORARIO', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold, letterSpacing: 1.5)),
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(shape: BoxShape.circle, color: Color(0xFFFF44AA)),
              ...
              child: Center(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    decoration: tieneTiempos ? TextDecoration.underline : TextDecoration.none,
                  ...
                  return AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: tieneTiempo 
                          ? [BoxShadow(color: blockColor.withOpacity(0.3), blurRadius: 4)]
                          : null,
                    ),
                  );
                }),
          ...
          child: Wrap(
            ...
            children: List.generate(_days.length, (index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(color: const Color(0xFF1E1B3A), borderRadius: BorderRadius.circular(6)),
                child: Text(
                  '${_days[index].toUpperCase()}: ${_scheduleData[index].length} slots',
                  style: const TextStyle(color: Color(0xFFFF44AA), fontSize: 10, fontWeight: FontWeight.bold),
                ),
              );
            }),
          ),
