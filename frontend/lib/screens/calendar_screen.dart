...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  Future<void> _cargarTareas() async {
    ...
    final tieneTareasManualesValidas = tareasManuales.whereType<Map>().any((
      task,
    ) {
  ...
  Widget _buildGamificationCard(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF6D4BC1).withValues(alpha: 0.10),
            blurRadius: 14,
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                GamificationScreen(userId: widget.userId),
                          ),
                        );
                      },
                      child: Ink(
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final diasRestantes =
                            ...
                            ? fechaEntrega.difference(_selectedDay!).inDays
                            : 0;
        ...
        child: esPantallaGrande
            ? Row(
                children: [
                  ...
                  Expanded(child: SafeArea(child: contenidoCalendario)),
                ],
              )
            : Stack(
                children: [
                  SafeArea(child: contenidoCalendario),
                  Align(
